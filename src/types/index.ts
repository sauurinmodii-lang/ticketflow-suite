...
export const ALL_PERMISSIONS: { key: Permission; label: string; group: string }[] = [
  ...
  { key: 'allocate_ticket', label: 'Allocate / Bulk Assign Ticket', group: 'Tickets' },
  ...
  { key: 'view_all_sites_data', label: 'View All Sites Data', group: 'Data Access' },
  { key: 'view_assigned_site_data', label: 'View Assigned Site Data', group: 'Data Access' },
  ...
  { key: 'view_sla', label: 'View SLA Configuration', group: 'SLA' },
  { key: 'manage_sla', label: 'Manage SLA Configuration', group: 'SLA' },
...
export type TicketStatus = 'Open' | 'Allocated' | 'In Progress' | 'Resolved' | 'Acknowledged' | 'Reopened' | 'Closed';
